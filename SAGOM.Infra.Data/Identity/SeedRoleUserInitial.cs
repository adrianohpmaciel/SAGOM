    ...
    public class SeedUserRoleInitial : ISeedUserRoleInitial
    {
        ...
        public void SeedUsers()
        {
            if (_userManager.FindByEmailAsync("usuario@localhost").Result == null)
            {
                ...
                IdentityResult result = _userManager.CreateAsync(user, "Testing.1212").Result;
            ...
            if (_userManager.FindByEmailAsync("employee@localhost").Result == null)
            {
                ApplicationUser user = new ApplicationUser();
                user.UserName = "employee@localhost";
                user.Email = "employee@localhost";
                user.NormalizedUserName = "EMPLOYEE@LOCALHOST";
