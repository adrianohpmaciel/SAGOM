...
namespace SAGOM.Domain.Tests
{
    public class PersonUnitTest1
    {
        ...
        {            
            Action action = () => new Person("CPF INVÁLIDO AQUI", "E-MAIL AQUI", "adriano", "maciel", "rua x", "(00) 0000 0000");
        ...
        {
            Action action = () => new Person("CPF AQUI", "E-MAIL AQUI", "adriano", "maciel", "rua x", "00 0000 0000");
        ...
        {
            Action action = () => new Person("CPF AQUI", "E-MAIL AQUI", "adriano1", "maciel", "rua e", "00-0.0000-0000");
        ...
        {
            Action action = () => new Person("CPF AQUI", "E-MAIL AQUI", "adriano", "maciel", "rua e", "000");
