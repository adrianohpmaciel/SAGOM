...
namespace SAGOM.Domain.Tests
{
    public class PersonUnitTest1
    {
        ...
        public void CreatePersonAsync_WithInalidCpf_ResultDomainException()
        {
            Action action = () => new Person("", "adriano", "maciel", "rua x", "(00) 0000 0000");
        ...
        {
            Action action = () => new Person("", "adriano1", "maciel", "rua e", "00-0.0000-0000");
        ...
        {
            Action action = () => new Person("", "adriano1", "maciel", "rua e", "0000-0000");
            action.Should().Throw<SAGOM.Domain.Validations.DomainExceptionValidation>().WithMessage("Invalid Name. Name cannot contains numbers or symbols");
        }
